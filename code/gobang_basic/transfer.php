...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($conn->query($update_name) === True) {
          echo "Succeed";
          header('Location: http://34.225.43.131/bigBang/code/StartPage.html?userid='. urlencode($userid));
      }
    }
     catch (Exception $e) {
...
<form method="post">
    ...
    <button type="button" class="b" onclick="document.location='StartPage.html?userid='+url_userid">Cancel</button>
    <br><br> 
